  ...
  return (
    <main className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-black text-white p-6 lg:p-12">
      <div className="lg:w-1/2 text-center lg:text-left mb-8 lg:mb-0">
        <p className="text-3xl md:text-4xl font-[var(--font-poppins)] font-bold text-amber-500 mb-2">
          HELLO!
        </p>
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-[var(--font-montserrat)] font-bold mb-4">
